...
import com.follov.R;
import com.follov.activityrecognition.ActivityUtils.REQUEST_TYPE;
import com.google.android.gms.common.ConnectionResult;
import com.google.android.gms.common.GooglePlayServicesUtil;

/**
 * Sample application that demonstrates the use of ActivityRecognitionClient}.
 * It registers for activity detection updates at a rate of 20 seconds, logs
 * them to a file, and displays the detected activities with their associated
 * confidence levels.
 * <p>
 ...
 */
public class ActivityRecognitionMainActivity extends Activity {
	...
	public Handler testHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			Toast.makeText(ActivityRecognitionMainActivity.this,
					(CharSequence) msg.obj, 0).show();
		}
	};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Set the main layout
		setContentView(R.layout.activity_recognition_main_activity);
