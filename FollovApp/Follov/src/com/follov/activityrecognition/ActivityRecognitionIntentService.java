...
public class ActivityRecognitionIntentService extends IntentService {
   ...
   // private int previousType = DetectedActivity.UNKNOWN;
    
    private boolean havebeenStayed = false;
    ...
    protected void onHandleIntent(Intent intent) {
    	...
    	FollovLocationService.PRINT_LOG(TAG, "activityRecognition onHandleIntent()");
        ...
        if (ActivityRecognitionResult.hasResult(intent)) {
            ...
            FollovLocationService.PRINT_LOG(TAG, mostProbableActivity.toString());
    		...
    		if(follovService != null){
	            ...
	            if(keepStaying(activityType)){
	            	follovService.increaseStayOnePositionCnt();
	            } else {
	            	follovService.setStayOnePositionCnt(0);
	            }
	            FollovLocationService.PRINT_LOG(TAG, "stayCnt : "+follovService.getStayOnePositionCnt());
    		}
...
//            }
     ...
     * @return
     */
    private boolean keepStaying(int currentType){
    	
    	if(!isMoving(currentType)){
    		
    		return havebeenStayed = false;
