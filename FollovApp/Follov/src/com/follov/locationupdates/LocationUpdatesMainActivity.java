 ...
 */
public class LocationUpdatesMainActivity extends FragmentActivity implements
        LocationListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.location_update_activity_main);
         ...
         */
        mLocationRequest.setInterval(FollovSetUp.UPDATE_INTERVAL_IN_MILLISECONDS_NOT_DATING);

        // Use high accuracy
        mLocationRequest.setPriority(LocationRequest.PRIORITY_HIGH_ACCURACY);

        // Set the interval ceiling to one minute
        mLocationRequest.setFastestInterval(FollovSetUp.FAST_INTERVAL_CEILING_IN_MILLISECONDS_NOT_DATING);
    ...
    public void getAddress(View v) {
        ...
        if (servicesConnected()) {
            ...
            (new LocationUpdatesMainActivity.GetAddressTask(this)).execute(currentLocation);
        }
    }
