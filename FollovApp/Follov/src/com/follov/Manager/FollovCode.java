...
public class FollovCode {
	public static final int POPUP_A = R.string.check_email;
	public static final int POPUP_B = R.string.check_password;
	public static final int POPUP_C = R.string.check_password2;
	public static final int POPUP_D = R.string.check_inputEmail;
	public static final int POPUP_E = R.string.check_couplePhone;
	public static final int POPUP_HTTP_ERROR = R.string.http_error;
	public static final int JOIN_ERROR_S = R.string.join_error;
	...
	public static final int LOGIN_DATA = 2004;
	...
	public static final int SHOW_MAPS = 102;
	
	
	
	public static final int FAST_LOCATION_REQUEST = 103;
	public static final int SLOW_LOCATION_REQUEST = 104;
	
	public static final int GCM_NETWORK_ERROR = 1000;
	
	public static final int SEND_LOCATION_TO_LOVER = 10000;
	public static final int SEND_PHOTO_TAKEN_SINAL_TO_LOVER = 100001;
	public static final int SEND_PHOTO_TAKEN_INFO_TO_LOVER = 100002;
	public static final int SEND_PHOTO_INFO_SAVE_FAILED_SIGNAL_TO_LOVER = 100003;
